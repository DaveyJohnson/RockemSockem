...
import Opponent from '../entity/Opponent';
...
export default class FgScene extends Phaser.Scene {
  ...
  preload() {
    // Preload Sprites
    this.load.multiatlas('boxingsprites', 'assets/spriteSheets/boxingsprites.json', 'assets/spriteSheets');
    this.load.image('ground', 'assets/sprites/transparentground.png');
    this.gameId = 1 //Number(window.localStorage.getItem('gameId'));
    this.myId = 1 //Number(window.localStorage.getItem('idKey'));
  
    // Preload Sounds
    this.load.audio('punch', 'assets/audio/punch-sound-fx.wav');
    this.load.audio('bell', 'assets/audio/boxing-bell.wav');
    this.load.audio('cheer', 'assets/audio/crowd-cheer.wav');
  }
  ...
  create() {
    ...
    // Create sounds
    this.bellSound = this.sound.add('bell');
